...
public static class ECSExtensions
{
    ...
    public static string JsonPrefabName(this PrefabGUID prefabGuid)
    {
        var name = Plugin.Localization.GetPrefabName(prefabGuid);
        return string.IsNullOrEmpty(name) ? prefabGuid.LookupName() : name;
    }

    public static string LookupName(this PrefabGUID prefabGuid)
    {
        var prefabCollectionSystem = Plugin._client.GetExistingSystemManaged<PrefabCollectionSystem>();
