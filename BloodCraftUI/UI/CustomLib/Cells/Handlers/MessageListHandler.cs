...
namespace BloodCraftEZLife.UI.CustomLib.Cells.Handlers
{
    ...
    /// </summary>
    public class MessageListHandler<TData, TCell> : ICellPoolDataSource<TCell> where TCell : IFormedCell
    {
        ...
        protected readonly Func<string,List<TData>> GetEntries;
        ...
        public MessageListHandler(ScrollPool<TCell> scrollPool, Func<string,List<TData>> getEntriesMethod,
        ...
        public void RefreshData(string user)
        {
            List<TData> allEntries = GetEntries(user);
